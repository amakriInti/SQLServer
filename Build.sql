...
GO
ALTER TABLE [dbo].AutoComplete ADD  CONSTRAINT [DF_AutoComplete_Id]  DEFAULT (newid()) FOR [Id]
GO
...
insert into Utilisateur(Id,Nom,CodePin,Statut) 
values ('C7F15A18-80E1-416F-ABAF-5B49B98764F4','Admin','#69!','255')
